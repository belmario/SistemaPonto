 ...
 * @author TECNICO
 */
public class ListaRelatorio extends javax.swing.JFrame {

    /**
     * Creates new form ListaRelatorio
     */
    ...
    private void ListarTodosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ListarTodosMouseClicked
        ...
        relatorio.geraRelatorioFuncionario();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaRelatorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaRelatorio().setVisible(true);
            }
        });
    }
